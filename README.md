...
1. [Django 3.2](https://docs.djangoproject.com/en/4.2/releases/3.2/)
    - Django was used to build the app. Installed and used libraries: gunicorn, dj_database_url, psycopg2, cloudinary, urllib3
